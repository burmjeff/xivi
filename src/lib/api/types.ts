...
export type DuplicateTVGIDReview = components['schemas']['DuplicateTVGIDReview'];
export type DuplicateTVGIDMergeResult = components['schemas']['DuplicateTVGIDMergeResult'];
