...
declare module '$env/static/private' {
	...
	export const SERVER_READ_TIMEOUT: string;
	export const JWT_SECRET_KEY: string;
	export const JWT_SECRET_KEY_EXPIRE_MINUTES_COUNT: string;
	export const ALLUSERSPROFILE: string;
	export const APPDATA: string;
	export const BAZEL_SH: string;
	...
	export const CUDA_PATH_V10_2: string;
	export const CUDA_PATH_V9_0: string;
	export const CUDA_PATH_V9_2: string;
	export const CYGWIN: string;
	...
	export const NDI_SDK_DIR: string;
	...
	export const NVCUDASAMPLES10_2_ROOT: string;
	...
	export const VBOX_INSTALL_PATH: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		JWT_SECRET_KEY_EXPIRE_MINUTES_COUNT: string;
		...
		CUDA_PATH_V10_2: string;
		CUDA_PATH_V9_0: string;
		CUDA_PATH_V9_2: string;
		CYGWIN: string;
		DriverData: string;
		EDITOR: string;
		ESET_OPTIONS: string;
